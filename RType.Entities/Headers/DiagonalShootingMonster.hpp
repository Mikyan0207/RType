...
class DiagonalShootingMonster final : public IMonster
{
public:
	DiagonalShootingMonster();
	DiagonalShootingMonster(const DiagonalShootingMonster&);
	DiagonalShootingMonster(DiagonalShootingMonster&&) noexcept;
	~DiagonalShootingMonster() override = default;

public:
	DiagonalShootingMonster& operator=(const DiagonalShootingMonster&) = delete;
	DiagonalShootingMonster& operator=(DiagonalShootingMonster&&) noexcept = delete;
...
private:
	...
	static constexpr float SHOOT_FREQUENCY = 0.4;
};

extern "C" RTYPEENTITIES_API IMonster * Instantiate(void)
{
	return new DiagonalShootingMonster;
}
